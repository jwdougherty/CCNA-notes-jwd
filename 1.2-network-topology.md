...
- and create a reliable network.
    ...
    **_Class Activity 1.0.1.2: Network by Design
    ...
    To get an idea of what using the hierarchical model can do to enhance the design process, you research the topic._**
...
In Figure 1-1, the following steps occur as the network grows from a small company to a global enterprise:
    ...
    The company begins as a small, single-location company.
    The company increases its number of employees.
    The company grows to multiple locations in the same city.
    The enterprise grows to multiple cities.
    The enterprise hires teleworkers.
    The enterprise expands to other countries (not all enterprises are international).

    The enterprise centralizes network management in a Network Operations Center (NOC).
    Figure 1-1
